...
const Mock = () => {
	return (
		<Container>
			...
			<div>
				<FriendCard user={{ fullName: "Ciobanu Paul", profileImageSource: "http://localhost:3000/avatars/ciobi.jpg" }}/>
				<FriendCard user={{ fullName: "Florin Pricop", profileImageSource: "http://localhost:3000/avatars/florin.jpg" }}/>
				<FriendCard user={{ fullName: "Tudor Citiriga", profileImageSource: "http://localhost:3000/avatars/tudor.jpg" }}/>
			</div>
		</Container>
	)
}
